...
# **0. Install packages and attach libraries**
...
df <- read.csv("C:/Users/GudievZK/Nextcloud/Data analysis/DA-54/2026.01.22_spgz_kpgz_okpd_ktru_rels_packs.csv", fileEncoding = "Windows-1251")
df_src <- read.csv("C:/Users/GudievZK/Nextcloud/Data analysis/DA-54/2026.01.22_spgz_kpgz_okpd_ktru_rels_packs.csv", fileEncoding = "Windows-1251")
...
|2  | How is the data organized? | The data is organized as a table consisting of **`r nrow(df)`** rows and **`r ncol(df)`** columns|
...
Removing duplicate rows (after deleting columns)
```{r}
dups <- df %>%
...
## **4.1 Key tasks and deliverable(s)**

### **4.1.1. Data aggregation**

### **4.1.2. Data organizing and formatting**

### **4.1.3. Perfoming calculations**

### **4.1.4. Identifying trends and relationships**

### **4.1.5. Summary of the analysis**

## **4.2 Guiding questions**
| N | Questions |  Answers  |
|-  |-----------|-----------|
| 1 | How should data be organized for analysis? | ... |
| 2 | Has the data been properly formatted? | ... |
| 3 | What trends and relationships were found? | ... |
| 4 | What insights help answer business questions? | ... |

\newpage

# **5. Report**

## **5.1 Key tasks and deliverable(s)**

### **5.1.1. Determening communication aproach**

### **5.1.2. Data visualizations creating**

### **5.1.3. Presenting findings**

### **5.1.4. Ensuring accessibility**

### **5.1.5. Support visualizations and key findings**

## **5.2 Guiding questions**
| N | Questions |  Answers  |
|-  |-----------|-----------|
| 1 | Were the bussines questions answered? | ... |
...
## **6.1. Key tasks and deliverable(s)**

### **6.1.1. Top three recommendations based on analysis**

## **6.2 Guiding questions**
| N | Questions |  Answers  |
|-  |-----------|-----------|
| 1 | What is the final conclusion? | ... | 
| 2 | How can the business apply the insights? | ... |
| 3 | What are the next steps? | ... |
| 4 | Is additional data needed? | ... | 

<<<<<<< HEAD


=======
>>>>>>> 429e181c5a8b7b8ec20c070575be90f7590b4c40

#	Next steps
1. Add new columns with the following attributes related spgz (rels_old_pgz_id (version id)): 
  1) Was it harmonized
  2) Was it standardized
2. Remove duplicated id_version_spgz_catalog (there are duplicate values across all columns except okpd2 and relations)
:::