...
#### Subsetting (обращение к конкретным кусочкам данных с помощью индекса) ####
...
####  Subsetting with condition (обращение к конкретным кусочкам данных, которые отвечают условиям) #### 
...
#### rbind, cbind (rowbind - соединение по строкам, columnbind - соединение по столбцам) ####
