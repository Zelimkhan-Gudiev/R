...
mean(my_data$score) # т.к. переменная в дата фрейме является вектром, то с данной переменной можно выполнять все операции доступные 
...
# yt[, 1:4] <- NULL # удалял не нужные столбцы Х, Х1, Х2, Х3
...
# то запиши в mtcars$even_gear2 значение 0. Нечетное - 2
...
even$even_gear <- 1 # создадим в данном дата фрейме новую переменную even$even_gear и запишим в нее значение 1
