...
#### yt (Descriptive statistics)_________________________________________________________________________________________ ####
...
#### yt (Aggregation) ________________________________________________________________________________________________####
...
#### yt (describe) ____________________________________________________________________________________________________________ ####
...
#### yt (describeBy)____________________________________________________________________________________####
...
subset(yt, reason %in% 'Дорожная карта и план по стандартизации')
